...
const SHOPIFY_SOURCE_METRICS = [
  ...
  ...withLegacy(PROVIDER_KEYS.shopify, "shopify_new_customers", "New customers", "number", "Nuovi clienti Shopify.", ["new_customers"]),
  ...withLegacy(PROVIDER_KEYS.shopify, "shopify_returning_customers", "Returning customers", "number", "Clienti ricorrenti Shopify.", ["returning_customers"]),
