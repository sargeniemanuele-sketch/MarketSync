...
export const providerKpiConfig = {
  [PROVIDER_KEYS.shopify]: {
    ...
    kpis: [
      ...
      { key: "shopify_new_customers", label: "New customers", unit: "number", aliases: ["new_customers"] },
      { key: "shopify_gross_sales", label: "Gross sales", unit: "currency", aliases: ["gross_sales"] },
      { key: "shopify_returning_customers", label: "Returning customers", unit: "number", aliases: ["returning_customers"] },
      { key: "shopify_new_customer_orders", label: "New customer orders", unit: "number", aliases: ["new_customer_orders"] },
      { key: "shopify_units_sold", label: "Units sold", unit: "number", aliases: ["units_sold"] },
      { key: "shopify_returning_customer_orders", label: "Returning customer orders", unit: "number", aliases: ["returning_customer_orders"] },
